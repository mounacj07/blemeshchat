...
public final class ActivitySetupBinding implements ViewBinding {
  ...
  private ActivitySetupBinding(@NonNull LinearLayout rootView, @NonNull Button buttonContinue,
  ...
  public static ActivitySetupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySetupBinding((LinearLayout) rootView, buttonContinue, editTextName);
    }
